...
export const demoProjects: SiteProject[] = [
  {
    ...
    evidence: [
      ...
      { id: 'ev-market', category: 'Market Context', title: 'Development context', value: 'Preliminary', summary: 'Several use types may warrant investigation, but no live market study has been performed.', status: 'UNCERTAIN', sourceName: 'Mock NFE PropertyScope', retrievedAt: '2026-07-20', confidence: 'LOW', verificationRequired: true, provenance: 'NFE_OS_ANALYSIS' }
    ],
    findings: [
